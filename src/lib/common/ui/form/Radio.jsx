...
export default class Radio extends Component {
  ...
  constructor(props, context) {
    ...
    if (this.props.name !== undefined) {
      throw new Error("Don't use name prop directly on Radio component, set name prop of parent RadioGroup");
    }
    ...
    if (this.props.value === undefined) {
      throw new Error(`Prop value is required for Radio component of radiogroup named "${context.radioGroup.name}"`);
    }
